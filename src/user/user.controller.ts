...
export class UserController {
  ...
  @Get('/search')
  searchUsers(@Query() searchUsersDto: SearchUsersDto): Promise<UserEntity[]> {
  ...
  @ApiNotFoundResponse({
    schema: { example: new NotFoundException(`User with id was not found!`) },
  })
  @ApiSecurity('bearer')
  @Get('/my-profile')
  ...
  @ApiBadRequestResponse({
    schema: {
      example: new HttpException(
        `User with ID has not been updated!`,
  ...
  @ApiConflictResponse({
    schema: {
      example: new ConflictException(
        'Gender should be only Male, Female and Unselected!',
      ),
    },
  })
  @ApiNotFoundResponse({
  ...
  @ApiNotFoundResponse({
    schema: {
      example: new NotFoundException(
        `User with this id was not found! Follow failed!`,
      ),
    },
  })
  @ApiBadRequestResponse({
    schema: {
      example: new BadRequestException(`A user cannot subscribe to himself!`),
    },
  })
  @ApiSecurity('bearer')
  @Post('/:id/follow')
  ...
  @ApiNotFoundResponse({
    schema: {
      example: new NotFoundException(
        `User with this id was not found! Unfollow failed!`,
      ),
    },
  })
  @ApiSecurity('bearer')
  ...
  @ApiNotFoundResponse({
    schema: { example: new NotFoundException(`User with id was not deleted!`) },
  })
  @ApiSecurity('bearer')
  @Delete(':id')
