...
export class AuthController {
  ...
  @ApiUnauthorizedResponse({
    schema: {
      example: new UnauthorizedException(
        `User with this activation link was not found!`,
      ),
    },
  })
  @ApiOkResponse({
    description:
      'success: true, message: `Account with email has been activated!`',
    schema: {
      example: {
        success: true,
  ...
  @ApiBadRequestResponse({
    schema: {
      example: new BadRequestException('User with this email was not found!'),
    },
  })
  @ApiOkResponse({
    description:
