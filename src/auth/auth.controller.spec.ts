...
describe('AuthController', () => {
  ...
  const mockAuthService = {
    register: jest
      .fn()
      .mockImplementation((registerCredentialsDto: RegisterCredentialsDto) => {
        return {
          message:
    ...
    login: jest
      .fn()
      .mockImplementation((loginCredentialsDto: LoginCredentialsDto) => {
        return { accessToken: token };
      }),

    forgotPassword: jest
      .fn()
      .mockImplementation((forgotPasswordDto: ForgotPasswordDto) => {
        return {
          message:
    ...
    changePassword: jest
      .fn()
      .mockImplementation(
        (user: UserEntity, changePasswordDto: ChangePasswordDto) => {
  ...
  it('should return info about change password success', () => {
    expect(
      authController.changePassword(mockUser, mockChangePasswordDto),
    ).toStrictEqual({
      success: true,
