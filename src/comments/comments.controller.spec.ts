...
describe('CommentsController', () => {
  ...
  const mockCommentService = {
    createComment: jest
      .fn()
      .mockImplementation(
        (createCommentDto: CreateCommentDto, user: UserEntity) => {
          return {
            ...mockComment,
    ...
    updateComment: jest
      .fn()
      .mockImplementation(
        (id: number, updateCommentDto: UpdateCommentDto, user: UserEntity) => {
          return {
            ...mockComment,
            id,
    ...
    deleteComment: jest
      .fn()
      .mockImplementation((id: number, user: UserEntity) => {
  ...
  it('should creat a comment', () => {
    expect(
      commentController.createComment(mockCreateCommentDto, mockUser),
    ).toEqual({
      ...mockComment,
  ...
  it('should update a comment', () => {
    expect(
      commentController.updateComment(1, mockUpdateCommentDto, mockUser),
    ).toEqual({
      ...mockComment,
      id: 1,
